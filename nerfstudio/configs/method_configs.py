...
from nerfstudio.models.depth_bakedsdf import DepthBakedSDFModelConfig
...
descriptions = {
    ...
    "depth-bakedsdf": "Implementation of BackedSDF with multi-res hash grids and depth-supervision"
}
method_configs["depth-bakedsdf"] = Config(
    method_name="depth-bakedsdf",
